...
const examples = [
  {
    ...
    note: "프로필 사진과 앨범 사진은 ‘내 추모관’에서 올릴 수 있습니다. 휴대폰이면 그 자리에서 찍어 올릴 수도 있습니다.",
  },
  {
    id: "story",
    label: "글과 신앙",
...
const steps = [
  ...
  {
    title: "등록 완료",
    text: "사진과 글을 다 준비한 뒤 ‘등록 완료하기’를 누르면 다른 분들이 보고 편지를 남길 수 있습니다. 그 전에는 가족만 보고, 등록을 마친 뒤에도 사진과 글을 더할 수 있습니다.",
  },
];
...
const questions = [
  ...
  },
  {
    ...
    answer:
      "네. 가족관 관리 화면에서 글(제목·소개글)과 사진, 유튜브 영상을 넣을 수 있습니다. 가족관에 올린 사진은 그 가족관에만 저장되어 비밀번호를 아는 가족만 볼 수 있고, 공개 추모관이나 다른 가족관에는 나오지 않습니다.",
  },
  {
...
/**
 * 이용 안내 본문 (2026-09-16). 홈페이지(/guide)와 키오스크 "이용 안내" 창이 같은 내용을 쓴다.
 * kiosk 변형은 다른 화면으로 가는 단추(추모관 만들기·찾기·편지·인생화원)를 빼고,
 * 창 스크롤에 묶인 목차 강조·해시 이동도 하지 않는다.
 */
        ...
        <div className="guide-inner guide-hero__grid">
          <div>
            ...
            <a className="guide-button" href="#records">
              어떻게 남겨지는지 보기 <ArrowDown size={18} aria-hidden="true" />
            </a>
          </div>
              ...
              >
                ...
                {selected.id === "story" && (
                  <>
                    ...
                    <p className="guide-preview__story">
                      평생 예배의 자리를 지키고, 이웃과 가진 것을 나누며 살고자
                      했습니다. 부족하고 넘어질 때도 많았지만, 주님은 늘 다시
                      일어설 힘을 주셨습니다. 남은 날들도 감사로 살며, 자녀와
                      손주들이 이 믿음 안에서 살아가기를 기도합니다.
                    </p>
                  </>
                )}
                {selected.id === "video" && (
                    ...
                    <div className="guide-preview__film">
                      ...
                      <div>
                        ...
                        <div className="guide-preview__interview-title">
                          ...
                          <small>인터뷰 표지 예시 · 재생 영상이 아닙니다</small>
                        </div>
                      </div>
                    </div>
                  </>
          ...
          <div className="guide-section-heading">
            ...
            <div className="guide-prepare__intro">
              ...
              <p className="guide-note">
                미리 추모관을 만들 때는 소천일을 비워둘 수 있습니다. 가족에게만
                전할 인사는 가족관의 소개글에 남겨 주세요.
              </p>
            </div>
          </div>
