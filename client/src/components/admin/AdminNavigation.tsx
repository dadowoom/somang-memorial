...
export default function AdminNavigation() {
  ...
  return (
    <>
      <aside className="fixed inset-y-16 left-0 z-40 hidden w-60 border-r border-[#b5b0a7] bg-[#fafafa] lg:flex lg:flex-col">
      ...
      <nav
        aria-label="관리자 메뉴"
        className="border-b border-[#b5b0a7] bg-[#fafafa] lg:hidden"
      >
